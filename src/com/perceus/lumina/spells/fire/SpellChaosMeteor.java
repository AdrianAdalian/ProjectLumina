...
public class SpellChaosMeteor extends Spell
{

	public SpellChaosMeteor()
	{
		super("ChaosMeteor", new String[] {
				"&r&7&ko&r&7&lSpell: &r&fChaos Meteor&r&7&ko&r",
				"&r&fElement: &r&cFire&r&f.",
				"&r&fSpell Type: &cOffensive&f.", 
				"&r&fPlummit a large ball of fire that explodes on impact.",
				"&r&fRange: 30 meters.",
