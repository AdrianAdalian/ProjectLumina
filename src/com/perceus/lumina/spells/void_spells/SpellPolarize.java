...
public class SpellPolarize extends Spell
{

	public SpellPolarize()
	{
		super("Polarize", new String[] {
				"&r&7&ko&r&7&lSpell: &r&fPolarize&r&7&ko&r",
				"&r&fElement: &r&3&lVOID&r&f.",
				"&r&fSpell Type: &cOffensive&d AOE&f.",
				"&r&fSummon an expanding singularity upon any target.",
