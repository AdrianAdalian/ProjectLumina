...
public class FireHat_Recipe
{
	static ItemStack final_item;
	
	public static void Init() 
	{
		final_item = ItemUtils.buildItem(Material.LEATHER_HELMET, PrintUtils.ColorParser("&r&fFire Hat"), 1, ColorableArmorMeta.class, (meta) -> {
	...
	{
		NamespacedKey k = new NamespacedKey(Lumina.instance, "fire_hat");
