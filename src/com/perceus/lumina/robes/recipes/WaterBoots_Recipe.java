...
public class WaterBoots_Recipe
{
	static ItemStack final_item;
	
	public static void Init() 
	{
		final_item = ItemUtils.buildItem(Material.LEATHER_BOOTS, PrintUtils.ColorParser("&r&fWater Boots"), 1, ColorableArmorMeta.class, (meta) -> {
	...
	{
		NamespacedKey k = new NamespacedKey(Lumina.instance, "water_boots");
