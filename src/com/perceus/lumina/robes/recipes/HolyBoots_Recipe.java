...
public class HolyBoots_Recipe
{
	...
	public static void Init() 
	{
		...
		final_item = ItemUtils.buildItem(Material.LEATHER_BOOTS, PrintUtils.ColorParser("&r&fHoly Boots"), 1, ColorableArmorMeta.class, (meta) -> {
	...
	{
		NamespacedKey k = new NamespacedKey(Lumina.instance, "holy_boots");
