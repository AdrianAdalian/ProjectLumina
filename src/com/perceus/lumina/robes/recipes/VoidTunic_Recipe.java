...
public class VoidTunic_Recipe
{
	static ItemStack final_item;
	
	public static void Init() 
	{
		final_item = ItemUtils.buildItem(Material.LEATHER_CHESTPLATE, PrintUtils.ColorParser("&r&fVoid Tunic"), 1, ColorableArmorMeta.class, (meta) -> {
	...
	{
		NamespacedKey k = new NamespacedKey(Lumina.instance, "void_tunic");
