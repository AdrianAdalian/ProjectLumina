...
public class GeoBoots_Recipe
{
	static ItemStack final_item;
	
	public static void Init() 
	{
		final_item = ItemUtils.buildItem(Material.LEATHER_BOOTS, PrintUtils.ColorParser("&r&fGeo Boots"), 1, ColorableArmorMeta.class, (meta) -> {
	...
	{
		NamespacedKey k = new NamespacedKey(Lumina.instance, "geo_boots");
